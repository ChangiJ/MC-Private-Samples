# Reference
# fragment: https://cms-pdmv-prod.web.cern.ch/mcm/public/restapi/requests/get_fragment/SUS-RunIIAutumn18FSPremix-00153/0
# MCM:      https://cms-pdmv-prod.web.cern.ch/mcm/requests?page=0&dataset_name=SMS*T1btbt*
...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",  # Load external LHE events via gridpack
    ...
    nEvents = cms.untracked.uint32(30),  # Number of events to generate from the gridpack
...
# PDG code           mass       particle
   ...
   1000021     %MGLU%             # ~g
   1000022     1.00000000E+03   # ~chi_10
   1000023     1.00000000E+05   # ~chi_20
   1000025     1.00000000E+05   # ~chi_30
   1000035     1.00000000E+05   # ~chi_40
   1000024     1.00000000E+03   # ~chi_1+
...
DECAY   1000024     1.0000000E+00   # chargino1 decays
1.00000000E+00    3       -3        -5        -5    # ~chi_1+ -> ~s + ~b + ~b
