...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",  # Load external LHE events via gridpack
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/RunIII/13p6TeV/slc7_amd64_gcc10/MadGraph5_aMCatNLO/SUSY_SMS/SMS-GlGl/SMS-GlGl_mGl-%i_tarball.tar.xz' % mglu),
